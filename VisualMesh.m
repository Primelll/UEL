...
% E. Mart�nez-Pa�eda and M. Mu�iz-Calvente
...
%Pasar el archivo a caracteres, detecta cambio de l�nea como delimitador checkbox_y
%si encuentra una l�nea en blanco la sustituye por comillas
file=textscan(fid,'%s','Delimiter','\n');
%fclose(fid);
%Para que quede en una columna del tipo Cell Array
flines=(file{1});
%Donde acabamos de leer
lif=length(flines); %�ltima linea del fichero
%fclose(fid);
